package com.exshell.api;

import com.exshell.request.CreateOrderRequest;
import com.exshell.request.DepthRequest;
import com.exshell.request.IntrustOrdersDetailRequest;
import com.exshell.response.*;
...
public class ApiClient {
    ...
    public List<Symbol> getSymbols() {
        ApiResponse<List<Symbol>> resp =
                get("/v1/pub/symbols", null, new TypeReference<ApiResponse<List<Symbol>>>() {
                });
    ...
    public List<Account> getAccounts() {
        ApiResponse<List<Account>> resp =
                get("/v1/priv/accounts", null, new TypeReference<ApiResponse<List<Account>>>() {
                });
        return resp.checkAndReturn();
    }
    ...
    public Long createOrder(CreateOrderRequest request) {
        ApiResponse<Long> resp =
                post("/v1/priv/orders/place", request, new TypeReference<ApiResponse<Long>>() {
                });
        return resp.checkAndReturn();
    }
    ...
    public KlineResponse kline(String symbol, String period, String size) {
        ...
        map.put("size", size);
        KlineResponse resp = get("/v1/mkt/kline", map, new TypeReference<KlineResponse<List<Kline>>>() {
        });
        return resp;
    }

    /**
     * GET /v1/mkt/aggregated 获取聚合行情(Ticker)
     *
     * @param symbol
     * @return
     */
    public MergedResponse merged(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        MergedResponse resp = get("/v1/mkt/aggregated", map, new TypeReference<MergedResponse<List<Merged>>>() {
        });
        return resp;
    }

    /**
     * GET /v1/mkt/depth 获取 Market Depth 数据
     *
     * @param request
     * @return
     */
    public DepthResponse depth(DepthRequest request) {
        ...
        DepthResponse resp = get("/v1/mkt/depth", map, new TypeReference<DepthResponse<List<Depth>>>() {
        });
        return resp;
    }

    /**
     * GET /v1/mkt/trade 获取 Trade Detail 数据
     *
     * @param symbol
     * @return
     */
    public TradeResponse trade(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        TradeResponse resp = get("/v1/mkt/trade", map, new TypeReference<TradeResponse>() {
        });
        return resp;
    }

    /**
     * GET /v1/mkt/tradeHistory 批量获取最近的交易记录
     *
     * @param symbol
     * @param size
     * @return
    ...
    public HistoryTradeResponse historyTrade(String symbol, String size) {
        ...
        map.put("symbol", symbol);
        map.put("size", size);
        HistoryTradeResponse resp = get("/v1/mkt/tradeHistory", map, new TypeReference<HistoryTradeResponse>() {
        });
        return resp;
    }

    /**
     * GET /v1/mkt/last24hr 获取 Market Detail 24小时成交量数据
     *
     * @param symbol
     * @return
     */
    public DetailResponse detail(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        DetailResponse resp = get("/v1/mkt/last24hr", map, new TypeReference<DetailResponse<Details>>() {
        });
        return resp;
    }
    ...
    /**
     * GET /v1/pub/symbols 查询系统支持的所有交易对及精度
     *
     * @param symbol
     * @return
     */
    public SymbolsResponse symbols(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        SymbolsResponse resp = get("/v1/pub/symbols", map, new TypeReference<SymbolsResponse<Symbols>>() {
        });
        return resp;
    }

    /**
     * GET /v1/pub/currencies 查询系统支持的所有币种
     *
     * @param symbol
     * @return
     */
    public CurrencysResponse currencys(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        CurrencysResponse resp = get("/v1/pub/currencies", map, new TypeReference<CurrencysResponse>() {
        });
        return resp;
    }

    /**
     * GET /v1/pub/timestamp 查询系统当前时间
     *
     * @return
     */
    public TimestampResponse timestamp() {
        TimestampResponse resp = get("/v1/pub/timestamp", null, new TypeReference<TimestampResponse>() {
        });
        return resp;
    }

    /**
     * GET /v1/priv/accounts 查询当前用户的所有账户(即account-id)
     *
     * @return
     */
    public AccountsResponse accounts() {
        AccountsResponse resp = get("/v1/priv/accounts", null, new TypeReference<AccountsResponse<List<Accounts>>>() {
        });
        return resp;
    }

    /**
     * GET /v1/priv/accounts/{account-id}/balance 查询指定账户的余额
     *
     * @param accountId
     * @return
     */
    public BalanceResponse balance(String accountId) {
        BalanceResponse resp = get("/v1/priv/accounts/" + accountId + "/balance", null, new TypeReference<BalanceResponse<Balance>>() {
        });
        return resp;
    }

    /**
     * POST /v1/priv/orders/order-id}/cancel 申请撤销一个订单请求
     *
     * @param orderId
     * @return
     */
    public SubmitcancelResponse submitcancel(String orderId) {
        SubmitcancelResponse resp = post("/v1/priv/orders/" + orderId + "/cancel", null, new TypeReference<SubmitcancelResponse>() {
        });
        return resp;
    }

    /**
     * POST /v1/priv/orders/batchCancel 批量撤销订单
     *
     * @param orderList
     * @return
     */
    public BatchcancelResponse submitcancels(List orderList) {
          ...
          BatchcancelResponse resp = post("/v1/priv/orders/batchCancel", parameterMap, new TypeReference<BatchcancelResponse<Batchcancel<List, List<BatchcancelBean>>>>() {
          });
          return resp;
    }

    /**
     * GET /v1/priv/orders/{order-id} 查询某个订单详情
     *
     * @param orderId
     * @return
     */
    public OrdersDetailResponse ordersDetail(String orderId) {
        OrdersDetailResponse resp = get("/v1/priv/orders/" + orderId, null, new TypeReference<OrdersDetailResponse>() {
        });
        return resp;
    }
    ...
    /**
     * GET /v1/priv/orders/{order-id}/matchResults 查询某个订单的成交明细
     *
     * @param orderId
     * @return
     */
    public MatchresultsOrdersDetailResponse matchresults(String orderId) {
        MatchresultsOrdersDetailResponse resp = get("/v1/priv/orders/" + orderId + "/matchResults", null, new TypeReference<MatchresultsOrdersDetailResponse>() {
        });
        return resp;
    }
    ...
    public IntrustDetailResponse intrustOrdersDetail(IntrustOrdersDetailRequest req) {
        ...
        IntrustDetailResponse resp = get("/v1/priv/orders/", map, new TypeReference<IntrustDetailResponse<List<IntrustDetail>>>() {
        });
        return resp;
    }
...
//  }
    ...
    <T> T call(String method, String uri, Object object, Map<String, String> params,
        ...
        sign.createSignature(this.accessKeyId, this.accessKeySecret, method, API_HOST, params);
        try {
